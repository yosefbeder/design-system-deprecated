var nr=Object.defineProperty;var E=Object.getOwnPropertySymbols;var D=Object.prototype.hasOwnProperty,G=Object.prototype.propertyIsEnumerable;var U=(e,o,n)=>o in e?nr(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n,f=(e,o)=>{for(var n in o||(o={}))D.call(o,n)&&U(e,n,o[n]);if(E)for(var n of E(o))G.call(o,n)&&U(e,n,o[n]);return e};var $=(e,o)=>{var n={};for(var l in e)D.call(e,l)&&o.indexOf(l)<0&&(n[l]=e[l]);if(e!=null&&E)for(var l of E(e))o.indexOf(l)<0&&G.call(e,l)&&(n[l]=e[l]);return n};import{C as h,s as a,r as F,R as d,H as cr,U as ir,a as dr,j as Y,u as sr,b,L as hr,c as V,d as X,e as _,f as K,g as ur,h as vr}from"./vendor.afd2ff55.js";const br=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))l(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const p of s.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&l(p)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerpolicy&&(s.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?s.credentials="include":i.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}};br();const y=h`
...
`,er=e=>{const o=a(e)`
		position: relative;
	`;return({children:l})=>{const i=yr(l),[s,p]=F.exports.useState(!1);return d.createElement(o,{id:i,onMouseEnter:()=>p(!0),onMouseLeave:()=>p(!1)},d.createElement(kr,{isShown:s,href:`#${i}`},d.createElement(cr,{size:".65em"})),l)}},wr=ir`
  to {
...
`,u=({children:e,content:o,position:n="bottom"})=>{const l=F.exports.useRef(null),[i,s]=F.exports.useState(!1);return d.createElement(Br,{ref:l,onPointerEnter:()=>{s(!0)},onPointerLeave:()=>{s(!1)}},e,d.createElement(Hr,{position:n,isShown:i},o))},T=a.div`
	position: absolute;
	content: '';
	top: 50%;
	left: var(--padding);
...
`,Cr=a.input.attrs(()=>({type:"checkbox"}))`
	display: block;
	width: var(--width);
	height: var(--height);
	border-radius: var(--rounded-full);
...
`,Fr=a.div`
	...
	position: relative;
`,P=n=>{var l=n,{children:e}=l,o=$(l,["children"]);return d.createElement(Fr,null,d.createElement(Cr,f({},o)),d.createElement(T,null))},I=a.input`
	width: 100%;
	min-width: 10rem;
	padding: var(--space-sm) var(--space-md);
	border: 1px solid var(--color-gray-200);
...
`,Tr=a.div`
	...
	position: relative;
`,k=n=>{var l=n,{children:e}=l,o=$(l,["children"]);return d.createElement(Tr,null,d.createElement(jr,f({},o)),d.createElement(tr,null))},r=Y.exports.jsx,t=Y.exports.jsxs,z=er(gr),v=er(pr),Pr=a.article`
	width: 100%;
	max-width: 45rem;
	min-height: 100vh;
	margin: 0 auto;
